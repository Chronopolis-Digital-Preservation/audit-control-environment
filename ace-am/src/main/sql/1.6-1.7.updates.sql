...
ALTER TABLE monitored_item MODIFY `FILEDIGEST` varchar(255) CHARACTER SET;
ALTER TABLE monitored_item MODIFY `STATE` char(1) CHARACTER SET;
ALTER TABLE logevent CHARACTER SET;
