...
<c:if test="${workingCollection != null}">
    <fieldset>
        ...
        <table id="detailstbl1">
            <tr onmouseout='javascript:this.style.background="#ffffff"; return false;' onmouseover='javascript:this.style.background="#e8e8e8"; return false;'><td>Audit Status: </td>
                <td>
                    <c:choose>
                        <c:when test="${workingCollection.fileAuditRunning}">File Audit in progress</c:when>
